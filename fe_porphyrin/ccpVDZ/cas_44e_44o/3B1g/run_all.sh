...
mpirun -np 48 $DICE_EXE final_input_1.dat > final_output.dat
mpirun -np 48 $DICE_EXE final_input_2.dat >> final_output.dat
mpirun -np 48 $DICE_EXE final_input_3.dat >> final_output.dat
mpirun -np 48 $DICE_EXE final_input_4.dat >> final_output.dat
